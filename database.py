...
from database_supabase import (
    create_account as supa_create_account, verify_account as supa_verify_account,
    get_account as supa_get_account, get_account_by_username as supa_get_account_by_username,
    get_account_by_tg_id as supa_get_account_by_tg_id, get_all_accounts as supa_get_all_accounts,
    account_exists as supa_account_exists, save_telegram_user_id as supa_save_telegram_user_id,
    get_telegram_id_by_owner as supa_get_telegram_id_by_owner,
    get_setting as supa_get_setting, set_setting as supa_set_setting,
    toggle_setting as supa_toggle_setting, get_all_logged_in_users as supa_get_all_logged_in_users,
    init_user_settings as supa_init_user_settings,
    get_token_balance as supa_get_token_balance, add_tokens as supa_add_tokens,
    deduct_tokens as supa_deduct_tokens, claim_daily_token as supa_claim_daily_token,
    get_token_stats as supa_get_token_stats, process_referral as supa_process_referral,
    get_referral_count as supa_get_referral_count,
    save_message_slot as supa_save_message_slot, get_message_slot as supa_get_message_slot,
    ...
    place_bet as supa_place_bet, get_bet_users as supa_get_bet_users,
    ...
    create_bet_game as supa_create_bet_game, join_bet_game as supa_join_bet_game,
    ...
    finish_bet_game as supa_finish_bet_game, expire_bet_game as supa_expire_bet_game,
    get_bet_game as supa_get_bet_game, get_expired_bet_games as supa_get_expired_bet_games,
    transfer_tokens as supa_transfer_tokens,
    # 🆕 توابع جدید
    save_session as supa_save_session, get_session as supa_get_session,
    delete_session as supa_delete_session, is_session_active as supa_is_session_active,
    create_world_cup_challenge as supa_create_world_cup_challenge,
    get_active_challenges as supa_get_active_challenges,
    get_challenge as supa_get_challenge, get_challenge_bets as supa_get_challenge_bets,
    set_challenge_winner as supa_set_challenge_winner,
    settle_challenge_bets as supa_settle_challenge_bets,
    place_bet_v2 as supa_place_bet_v2, transfer_diamonds as supa_transfer_diamonds,
    create_lottery as supa_create_lottery, update_lottery_message as supa_update_lottery_message,
    get_lottery as supa_get_lottery, join_lottery as supa_join_lottery,
    get_lottery_participants as supa_get_lottery_participants,
    finish_lottery as supa_finish_lottery,
    SETTING_DEFAULTS, _hash_pw,
)
...
__all__ = [
    'create_account', 'verify_account', 'get_account', 'get_account_by_username',
    'get_account_by_tg_id', 'get_all_accounts', 'account_exists', 'save_telegram_user_id',
    'get_telegram_id_by_owner', 'get_setting', 'set_setting', 'toggle_setting',
    'get_all_logged_in_users', 'init_user_settings', 'get_token_balance', 'add_tokens',
    'deduct_tokens', 'claim_daily_token', 'get_token_stats', 'process_referral',
    'get_referral_count', 'add_enemy', 'remove_enemy', 'get_enemies', 'is_enemy',
    'clear_enemies', 'get_enemy_count', 'add_friend', 'remove_friend', 'get_friends',
    'is_friend', 'clear_friends', 'get_friend_count', 'save_message_slot', 'get_message_slot',
    'add_scheduled_message', 'get_pending_scheduled', 'mark_scheduled_sent',
    'log_deleted_message', 'get_deleted_messages', 'add_silent_chat', 'remove_silent_chat',
    'is_silent_chat', 'add_silent_user', 'remove_silent_user', 'is_silent_user',
    ...
    'create_worldcup_bet', 'update_challenge_message', 'get_active_worldcup_bet',
    'get_all_active_worldcup_bets', 'get_worldcup_bet_by_message', 'place_bet',
    'get_bet_users', 'finish_worldcup_bet', 'get_challenge_settings',
    'update_challenge_settings', 'create_bet_game', 'join_bet_game', 'get_active_bet_game',
    'get_all_active_bet_games', 'get_bet_game_by_message', 'finish_bet_game',
    'expire_bet_game', 'get_bet_game', 'get_expired_bet_games', 'transfer_tokens',
    ...
    'place_bet_v2', 'transfer_diamonds', 'create_lottery', 'update_lottery_message',
    'get_lottery', 'join_lottery', 'get_lottery_participants', 'finish_lottery',
]
